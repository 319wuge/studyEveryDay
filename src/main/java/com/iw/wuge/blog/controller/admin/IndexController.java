...
import com.iw.wuge.blog.dto.BackResponse;
import com.iw.wuge.blog.dto.LogActions;
import com.iw.wuge.blog.dto.Statistics;
import com.iw.wuge.blog.dto.Types;
import com.iw.wuge.blog.exception.TipException;
import com.iw.wuge.blog.ext.Commons;
import com.iw.wuge.blog.init.TaleConst;
import com.iw.wuge.blog.model.Comments;
import com.iw.wuge.blog.model.Contents;
import com.iw.wuge.blog.model.Logs;
import com.iw.wuge.blog.model.Users;
import com.iw.wuge.blog.service.LogService;
import com.iw.wuge.blog.service.OptionsService;
import com.iw.wuge.blog.service.SiteService;
import com.iw.wuge.blog.service.UsersService;
...
public class IndexController extends BaseController {
    ...
    public RestResponse doAdvanced(@QueryParam String cache_key, @QueryParam String block_ips,
        ...
        if(StringKit.isBlank(rewrite_url)){
            Blade.$().route("/:pagename" + rewrite_url, IndexController.class, "page");
            Blade.$().routeMatcher().update();
        }
